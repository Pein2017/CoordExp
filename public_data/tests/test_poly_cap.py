...
Verifies alignment with docs/data/CONTRACT.md (only bbox_2d and poly, no line/quad).
"""
...
def test_data_contract_compliance():
    """Test that output conforms to docs/data/CONTRACT.md."""
    print("\n" + "=" * 60)
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if errors:
            ...
            print("  ✓ All records comply with docs/data/CONTRACT.md")
            return True
