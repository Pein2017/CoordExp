...
def download_file(
    url: str, output_path: str, expected_size_mb: Optional[int] = None
) -> bool:
    """
    ...
    if os.path.exists(output_path):
        ...
        if (
            expected_size_mb
            and abs(size_mb - expected_size_mb) > expected_size_mb * 0.1
        ):
...
Storage Requirements:
  ...
  - Total: ~25 GB
    ...
    try:
        ...
        print("=" * 60)
        print("\nNext steps:")
        print("  1. Convert to JSONL:")
        print("     python scripts/convert_lvis.py")
        print("  2. Create samples:")
