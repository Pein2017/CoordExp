...
WITNESS_RUNNER = Path(escape_witness.__file__)
WITNESS_REDUCER = Path(escape_witness_reduce.__file__)
...
def _validate_packet_population(packet: Mapping[str, Any]) -> None:
    geom = load_json(GEOM)
...
def _witness_modules() -> tuple[Any, Any]:
    return escape_witness, escape_witness_reduce
