"""Four frozen recent-row interventions through the original heterogeneous native batch."""
...
ROOT=Path('/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-bridge-factorial')
...
def execute(cell):
 ...
 try:
  ...
  if cell!='C00':
   ...
   receipt['control_gate']=bind(ROOT/'runtime/C00/receipt.json')
...
if __name__=='__main__':
 p=argparse.ArgumentParser();p.add_argument('cell',choices=['C00','C10','C01','C11']);execute(p.parse_args().cell)
