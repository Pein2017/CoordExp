...
class Runtime:
    ...
    def _run_job(self, job: dict[str, Any]) -> dict[str, Any]:
        ...
        # The original heterogeneous batch may be padded before the appended
        # native suffix.  Validate the suffix itself; comparing the complete
        # row mask to the batch-wide width falsely rejects shorter companions.
