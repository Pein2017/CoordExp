---
doc_id: docs.coordexp-infras
layer: docs
doc_type: canonical-implementation-guide
status: canonical
domain: repo
summary: Production routing guide for the coordexp-infras training, inference, evaluation, and artifact infrastructure.
tags: [coordexp-infras, training, inference, eval, routing, production]
updated: 2026-08-24
---

# coordexp-infras Canonical Infrastructure

coordexp-infras is the current production implementation route on repository
`main`. This page describes the live source and config ownership; stable
compatibility semantics belong to the linked `coordexp-infras-*` OpenSpecs. It
...
- `configs/coordexp_infras/prod/` for production-shaped training configs;
- `configs/coordexp_infras/smoke/` for small training checks;
- `configs/coordexp_infras/infer/` for inference configs.
...
- [config runtime](../openspec/specs/coordexp-infras-config-runtime/spec.md)
- [data/template/encoding](../openspec/specs/coordexp-infras-data-template-encoding/spec.md)
- [packing/forward](../openspec/specs/coordexp-infras-packing-forward/spec.md)
- [supervision/losses](../openspec/specs/coordexp-infras-supervision-losses/spec.md)
...
- [inference backend trace](../openspec/specs/coordexp-infras-infer-backend-trace/spec.md)
- [inference execution model](../openspec/specs/coordexp-infras-infer-execution-model/spec.md)
