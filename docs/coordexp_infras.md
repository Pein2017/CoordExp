...
status: canonical
domain: repo
summary: Current routing guide for the coordexp-infras training, inference, evaluation, and artifact infrastructure.
tags: [coordexp-infras, training, inference, eval, routing]
updated: 2026-07-11
---

# coordexp-infras Canonical Infrastructure

coordexp-infras is the current implementation route on repository `main`. This
page describes the live source and config ownership; stable compatibility
semantics belong to the linked `coordexp-infras-*` OpenSpecs.
