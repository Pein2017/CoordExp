...
Create `scripts/probes/coordexp_infras/qwen_processor_forward_probe.py` and
`scripts/probes/coordexp_infras/fa2_varlen_probe.py` later in Wave 1B.
...
```bash
python scripts/probes/coordexp_infras/qwen_processor_forward_probe.py \
  --output-dir outputs/probes/coordexp_swift/qwen_processor_only
CUDA_VISIBLE_DEVICES=6 python scripts/probes/coordexp_infras/qwen_processor_forward_probe.py \
  --run-model-forward --device cuda --dtype bfloat16
python scripts/probes/coordexp_infras/fa2_varlen_probe.py \
  --device cpu --dtype bfloat16 \
  --output-dir outputs/probes/coordexp_swift/fa2_varlen_cpu
CUDA_VISIBLE_DEVICES=6 python scripts/probes/coordexp_infras/fa2_varlen_probe.py \
