...
Verified from `/data/CoordExp/.worktrees/coordexp-infras`:
...
Executed from `/data/CoordExp/.worktrees/coordexp-infras` on 2026-06-30:

```bash
CUDA_VISIBLE_DEVICES=7 python scripts/probes/coordexp_infras/dora_roundtrip.py \
