# coordexp-infras Src Rebuild Roadmap And Implementation Plan
...
> in `docs/superpowers/plans/2026-07-02-coordexp-infras-production-relaunch-roadmap.md`
> and the OpenSpec change `prepare-coordexp-infras-production-relaunch`.

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Rebuild the coordexp-infras `src/` training infrastructure from the approved OpenSpec baseline into a professional, inspectable, five-step-smoke-verified Qwen3-VL supervised training stack.
...
- Active worktree: `/data/CoordExp/.worktrees/coordexp-infras`
- OpenSpec change: `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/`
- OpenSpec tasks: `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/tasks.md`
- OpenSpec design: `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/design.md`
- OpenSpec specs:
  - `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-config-runtime/spec.md`
  - `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-data-template-encoding/spec.md`
  - `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-packing-forward/spec.md`
  - `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-supervision-losses/spec.md`
  - `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-adapters-embeddings-optim/spec.md`
  - `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-training-artifacts/spec.md`
  - `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-vertical-smoke/spec.md`
- Design decisions: `/data/CoordExp/.worktrees/coordexp-infras/docs/architecture/proposals/2026-06-27-coordexp-infras/DECISIONS.md`
- Approval cards: `/data/CoordExp/.worktrees/coordexp-infras/docs/architecture/proposals/2026-06-27-coordexp-infras/BLUEPRINT.md`
- Review triage: `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/review-triage.md`
- Current legacy source reference: `/data/CoordExp/.worktrees/coordexp-infras/src/`
- Future legacy source archive: `/data/CoordExp/.worktrees/coordexp-infras/reference/legacy_src/`
- Archived legacy OpenSpec reference: `/data/CoordExp/.worktrees/coordexp-infras/reference/legacy_openspec_2026-06-29/`
...
- Wave 1B isolated probes under `scripts/probes/coordexp_infras/` only after
...
- Do not let exploratory probes become production modules by accident; probes
  live under `scripts/probes/coordexp_infras/` and must be promoted deliberately.
...
docs/architecture/proposals/2026-06-27-coordexp-infras/source-studies/
  dora.md
  special-token-embeddings.md
  qwen-noresize-mrope-fa2.md

scripts/probes/coordexp_infras/
  dora_roundtrip.py
...
**Files:**
- Read: `/data/CoordExp/.worktrees/coordexp-infras/AGENTS.md`
- Read: `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/tasks.md`
- Read: `/data/CoordExp/.worktrees/coordexp-infras/docs/architecture/proposals/2026-06-27-coordexp-infras/BLUEPRINT.md`
- Read: `/data/CoordExp/.worktrees/coordexp-infras/docs/architecture/proposals/2026-06-27-coordexp-infras/DECISIONS.md`
- Modify only after approval: no source files.

### Slice 0.1: Preflight State Snapshot

- [ ] Run `git status --short --branch` from `/data/CoordExp/.worktrees/coordexp-infras`.
- [ ] Run `openspec instructions apply --change rebuild-coordexp-infras-training-infra --json`.
...
**Stop condition:** if the worktree path is not `/data/CoordExp/.worktrees/coordexp-infras`, stop and ask.
...
**Files:**
- Create: `/data/CoordExp/.worktrees/coordexp-infras/docs/architecture/proposals/2026-06-27-coordexp-infras/source-studies/dora.md`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/docs/architecture/proposals/2026-06-27-coordexp-infras/source-studies/special-token-embeddings.md`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/docs/architecture/proposals/2026-06-27-coordexp-infras/source-studies/qwen-noresize-mrope-fa2.md`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/scripts/probes/coordexp_infras/dora_roundtrip.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/scripts/probes/coordexp_infras/special_token_embeddings_roundtrip.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/scripts/probes/coordexp_infras/qwen_processor_forward_probe.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/scripts/probes/coordexp_infras/fa2_varlen_probe.py`
...
- [ ] Implement `scripts/probes/coordexp_infras/dora_roundtrip.py` to load the local base model with `local_files_only=True`, initialize the selected DoRA mechanism on a minimal target set, run one tiny forward pass, save adapter payloads to `outputs/probes/coordexp_swift/dora_roundtrip/`, reload base-plus-adapter, and compare output shape plus finite logits.
...
```bash
python scripts/probes/coordexp_infras/dora_roundtrip.py
```
...
- [ ] Implement `scripts/probes/coordexp_infras/special_token_embeddings_roundtrip.py` to select a small subset of the final token group, apply deterministic nonzero deltas, save compact delta metadata and tensor payload, reload into a fresh base model, and verify that only selected ids changed.
- [ ] Assert that loaded selected rows/logit columns equal the trained values
  under the recorded additive-or-absolute semantics.
- [ ] Run:

```bash
python scripts/probes/coordexp_infras/special_token_embeddings_roundtrip.py
```
...
- [ ] Implement `scripts/probes/coordexp_infras/qwen_processor_forward_probe.py` to load `AutoProcessor` and model from `/data/CoordExp/model_cache/models/Qwen/Qwen3-VL-2B-Instruct-coordexp-natural-adjacent`.
- [ ] Implement `scripts/probes/coordexp_infras/fa2_varlen_probe.py` to capture the branch-level evidence required by the packing-forward spec.
- [ ] Record findings in `source-studies/qwen-noresize-mrope-fa2.md`.
...
- [ ] Request an independent review of `source-studies/*.md` and
  `scripts/probes/coordexp_infras/*.py`.
...
**Files:**
- Move: `/data/CoordExp/.worktrees/coordexp-infras/src/` to `/data/CoordExp/.worktrees/coordexp-infras/reference/legacy_src/`
- Create: all package markers in the final topology.
- Create: `/data/CoordExp/.worktrees/coordexp-infras/configs/base.yaml`
- Create as needed later: `/data/CoordExp/.worktrees/coordexp-infras/configs/directions/<direction>/base.yaml`
- Keep smoke config at: `/data/CoordExp/.worktrees/coordexp-infras/tests/fixtures/smoke/qwen3_vl_single_image_pack/config.yaml`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/common/errors.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/config/schema.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/config/loader.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/config/schedule.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/config/fingerprints.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/artifacts/manager.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/artifacts/manifest.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/train.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/tests/fixtures/smoke/qwen3_vl_single_image_pack/`
- Create or update current config/runtime tests under
  `/data/CoordExp/.worktrees/coordexp-infras/tests/config/` and
  `/data/CoordExp/.worktrees/coordexp-infras/tests/runtime/`.
- Create or update current smoke/pipeline tests under
  `/data/CoordExp/.worktrees/coordexp-infras/tests/training/`.
...
**Files:**
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/data/examples.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/data/jsonl.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/data/images.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/data/validation.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/templates/renderer.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/templates/spans.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/qwen/loading.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/qwen/tokenizer.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/qwen/encoding.py`
- Create or update current data/template/Qwen tests under
  `/data/CoordExp/.worktrees/coordexp-infras/tests/data/`,
  `/data/CoordExp/.worktrees/coordexp-infras/tests/templates/`, and
  `/data/CoordExp/.worktrees/coordexp-infras/tests/qwen/`.
...
**Files:**
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/packing/sequence.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/packing/planner.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/packing/mapping.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/qwen/mrope.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/qwen/forward.py`
- Modify after the basic trainer exists: `/data/CoordExp/.worktrees/coordexp-infras/src/training/pack_cache.py`
- Modify after the basic trainer exists: `/data/CoordExp/.worktrees/coordexp-infras/src/training/pipeline.py`
- Create or update current packing/forward tests under
  `/data/CoordExp/.worktrees/coordexp-infras/tests/packing/` and
  `/data/CoordExp/.worktrees/coordexp-infras/tests/qwen/`.
...
**Files:**
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/supervision/tokens.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/supervision/alignment.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/losses/context.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/losses/ce.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/losses/token_type_gate.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/losses/normalizers.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/losses/runner.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/losses/finite.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/metrics/accuracy.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/metrics/events.py`
- Create or update current supervision/loss tests under
  `/data/CoordExp/.worktrees/coordexp-infras/tests/supervision/` and
  `/data/CoordExp/.worktrees/coordexp-infras/tests/losses/`.
...
**Files:**
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/qwen/adapters.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/qwen/special_token_embeddings.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/optim/groups.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/optim/builder.py`
- Create or update current adapter/token/optimizer tests under
  `/data/CoordExp/.worktrees/coordexp-infras/tests/adapters/`,
  `/data/CoordExp/.worktrees/coordexp-infras/tests/tokens/`, and
  `/data/CoordExp/.worktrees/coordexp-infras/tests/optim/`.
...
**Files:**
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/training/stream.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/training/trainer.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/training/step.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/runtime/accelerate_runtime.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/runtime/deepspeed_status.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/runtime/distributed.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/artifacts/checkpoints.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/artifacts/receipts.py`
- Create: `/data/CoordExp/.worktrees/coordexp-infras/src/eval/forward.py`
...
**Files:**
- Read/write runtime artifacts under ignored `/data/CoordExp/.worktrees/coordexp-infras/outputs/smoke/qwen3_vl_single_image_pack/`
- Update only if evidence requires it: smoke fixture files under `/data/CoordExp/.worktrees/coordexp-infras/tests/fixtures/smoke/qwen3_vl_single_image_pack/`
...
**Files:**
- Modify: `/data/CoordExp/.worktrees/coordexp-infras/openspec/changes/rebuild-coordexp-infras-training-infra/tasks.md`
- Modify: `/data/CoordExp/.worktrees/coordexp-infras/docs/architecture/proposals/2026-06-27-coordexp-infras/BLUEPRINT.md`
- Create or modify: `/data/CoordExp/.worktrees/coordexp-infras/docs/superpowers/plans/2026-06-30-coordexp-infras-src-rebuild-roadmap.md`
...
| --- | --- | --- |
| OpenSpec validity | Wave 0 | `openspec validate rebuild-coordexp-infras-training-infra --strict` |
| Apply progress | Wave 0 and after each wave | `openspec instructions apply --change rebuild-coordexp-infras-training-infra --json` |
...
`docs/superpowers/plans/2026-06-30-coordexp-infras-roadmap-audit-prompt.md`
...
```text
You are implementing coordexp-infras in /data/CoordExp/.worktrees/coordexp-infras.

Read these first:
- AGENTS.md
- docs/superpowers/plans/2026-06-30-coordexp-infras-src-rebuild-roadmap.md
- openspec/changes/rebuild-coordexp-infras-training-infra/tasks.md
- openspec/changes/rebuild-coordexp-infras-training-infra/design.md
- openspec/changes/rebuild-coordexp-infras-training-infra/specs/**/*.md
