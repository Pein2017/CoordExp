# coordexp-infras Wave 1A Source Study Plan

## Purpose

Wave 1A is the read-only source-study kickoff for the coordexp-infras rebuild.
...
- `docs/superpowers/plans/2026-06-30-coordexp-infras-execution-charter.md`
...
- `openspec/changes/rebuild-coordexp-infras-training-infra/specs/**/spec.md`
...
- creating probe scripts under `scripts/probes/coordexp_infras/`;
