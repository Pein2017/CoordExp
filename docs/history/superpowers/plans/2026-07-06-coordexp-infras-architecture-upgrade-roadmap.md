# coordexp-infras Architecture Upgrade Roadmap
...
Adopt the architecture review's main diagnosis: coordexp-infras V1 has a real
...
5. **Authority Docs Sweep**
   ...
   - Make coordexp-infras V1 local modules the unambiguous current authority for
     this worktree.
...
- missing or stale pointers from `docs/coordexp_infras.md`,
