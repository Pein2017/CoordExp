# coordexp-infras Roadmap Audit Prompt
...
Repository/worktree:
/data/CoordExp/.worktrees/coordexp-infras

Objective:
Audit whether the coordexp-infras implementation roadmap is safe and sufficient
...
- openspec/changes/rebuild-coordexp-infras-training-infra/review-triage.md
- openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-config-runtime/spec.md
- openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-data-template-encoding/spec.md
- openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-packing-forward/spec.md
- openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-supervision-losses/spec.md
- openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-adapters-embeddings-optim/spec.md
- openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-training-artifacts/spec.md
- openspec/changes/rebuild-coordexp-infras-training-infra/specs/coordexp-infras-vertical-smoke/spec.md
...
openspec status --change rebuild-coordexp-infras-training-infra --json
openspec validate rebuild-coordexp-infras-training-infra --strict
openspec instructions apply --change rebuild-coordexp-infras-training-infra --json
