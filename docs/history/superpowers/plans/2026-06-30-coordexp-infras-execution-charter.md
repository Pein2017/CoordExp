# coordexp-infras Long-Term Execution Charter

## Purpose

This charter governs the long-running rebuild of the coordexp-infras training
infrastructure in `/data/CoordExp/.worktrees/coordexp-infras`. It records the
...
`rebuild-coordexp-infras-training-infra`, `DECISIONS.md`, and `BLUEPRINT.md`.
...
`docs/superpowers/plans/2026-07-02-coordexp-infras-production-relaunch-roadmap.md`,
and the follow-on OpenSpec change is `prepare-coordexp-infras-production-relaunch`.

## Goal

Rebuild `src/` into a functional, review-gated, smoke-verified coordexp-infras
