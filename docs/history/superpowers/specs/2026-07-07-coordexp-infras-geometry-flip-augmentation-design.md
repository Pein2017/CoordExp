# coordexp-infras Geometry Flip Augmentation Design

## Objective

Add a minimal, auditable data-augmentation pipeline for coordexp-infras V1 that
...
coordexp-infras augmentation design targets `coord_jsonl_len12000` rows and
...
coordexp-infras raw examples use coordinate-bin boxes in canonical
