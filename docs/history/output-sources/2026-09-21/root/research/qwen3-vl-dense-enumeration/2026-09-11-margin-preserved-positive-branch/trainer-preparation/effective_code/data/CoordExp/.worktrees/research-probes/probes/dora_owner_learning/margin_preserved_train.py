...
FULL_MAX_MODEL_FORWARDS_PER_RANK = 528
FULL_MAX_IMAGE_FORWARDS_PER_RANK = 528
...
def _protocol() -> dict[str, Any]:
    return {
        ...
        "full_bounds": {
            ...
            "model_forwards": 3510, "image_forwards": 3510,
...
def finalize(output_root: Path) -> dict[str, Any]:
    ...
    expected_model_forwards = 300 if mode == "smoke" else 3510
    require(
    ...
    receipt = {
        **provisional,
        ...
        "margin_signal": {
            ...
            "final_pre_update": margin_summaries[-1],
        },
