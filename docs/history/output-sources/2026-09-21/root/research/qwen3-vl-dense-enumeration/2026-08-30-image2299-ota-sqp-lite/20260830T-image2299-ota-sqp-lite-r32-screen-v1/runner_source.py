...
R32_MARGIN_DRIFT_TOLERANCE = 5e-5
R32_OLD_GRAM_RTOL = 5e-5
R32_OLD_GRAM_ATOL = 5e-3
...
def _r32_tangent_gate(
    *, comparator_gram: np.ndarray, old_gram: np.ndarray, added_gram: np.ndarray,
    ...
    if not np.allclose(
        old_gram, comparator_gram, rtol=R32_OLD_GRAM_RTOL, atol=R32_OLD_GRAM_ATOL,
    ):
    ...
    return {
        ...
        "added_gram_numerically_psd": psd,
        "added_gram_nonzero": nonzero,
        ...
        "strict_feasible_advantage": advantage,
...
def _r32_margin_drift(
    *, live_target_panel: Mapping[str, Any], live_cut_margins: Sequence[float],
    ...
    if maximum > R32_MARGIN_DRIFT_TOLERANCE:
