"""One near-boundary y1 edit through the accepted original heterogeneous native batch."""
...
ROOT=Path('/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control')
...
if __name__=='__main__':
 p=argparse.ArgumentParser();p.add_argument('cell',choices=['Y1_998']);execute(p.parse_args().cell)
