# Natural inference — candidate, awaiting root acceptance
...
|---|---|---:|---:|---:|---:|---:|
| human13 / 392 | tied-original | 175 / 217 | 8 | 11 / 0 | 69 | 13 / 0 |
| human13 / 392 | tied-normalized | 167 / 225 | 9 | 0 / 0 | 67 | 13 / 0 |
| human13 / 392 | untied+axis-original | 167 / 225 | 84 | 0 / 0 | 153 | 13 / 0 |
| human13 / 392 | untied+axis-normalized | 174 / 218 | 4 | 3 / 0 | 57 | 13 / 0 |
| refined5 / 178 | tied-original | 12 / 166 | 420 | 493 / 3 | 468 | 2 / 3 |
| refined5 / 178 | tied-normalized | 33 / 145 | 322 | 307 / 2 | 353 | 3 / 2 |
| refined5 / 178 | untied+axis-original | 33 / 145 | 329 | 301 / 2 | 363 | 3 / 2 |
| refined5 / 178 | untied+axis-normalized | 79 / 99 | 0 | 0 / 0 | 35 | 5 / 0 |
| sentinel / 919 | tied-original | 580 / 339 | 604 | 174 / 2 | 998 | 126 / 2 |
| sentinel / 919 | tied-normalized | 584 / 335 | 111 | 284 / 1 | 434 | 127 / 1 |
| sentinel / 919 | untied+axis-original | 580 / 339 | 145 | 520 / 2 | 502 | 126 / 2 |
| sentinel / 919 | untied+axis-normalized | 598 / 321 | 37 | 8 / 0 | 373 | 128 / 0 |
...
|---|---|---:|---:|---|
| human13 | tied | 7 / 15 | -8 | not estimated |
| human13 | untied+axis | 14 / 7 | +7 | not estimated |
| refined5 | tied | 22 / 1 | +21 | not estimated |
| refined5 | untied+axis | 47 / 1 | +46 | not estimated |
| sentinel | tied | 27 / 23 | +4 | [-17.0, 31.0] |
| sentinel | untied+axis | 29 / 11 | +18 | [-1.0, 42.0] |
...
Authoritative [result](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-highconfidence18-natural/result.json), [reduction](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-highconfidence18-natural/reduction.json), [verification](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-highconfidence18-natural/verification.json), [physical sidecar](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-highconfidence18-natural/physical-review/final-review.json), [artifact map](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-highconfidence18-natural/ARTIFACTS.md), [terminal](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-highconfidence18-natural/terminal.json). CPU replay: `PYTHONPATH=. python /data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-highconfidence18-natural/reduce.py --output /tmp/untied-natural-recheck.json`.

A used 55804 model forwards, 160 vision passes, 85553 active generated tokens and 202369 padded token work; completed-worker allocated time 6704.372 GPU-seconds, including load/qualification. Peak memory and per-group clocks remain in receipts. No dropped/failed scientific groups, no quality retries. No automatic follow-up. Root owns acceptance and next decisions.
