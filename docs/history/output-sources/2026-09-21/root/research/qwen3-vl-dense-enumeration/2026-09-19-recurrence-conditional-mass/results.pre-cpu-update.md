...
- Earlier mechanical qualification cost preserved separately: **5** model and **5** vision forwards, 0 scientific draws.
...
| **q legal repeat** | **441** | **3.83%**; Wilson 95% [0.0349, 0.0419] |
...
| Panel stratum | Model | Cohort | States | Images | Draws | Legal repeats | q | Wilson 95% | Greedy repeat states |
|---|---|---|---:|---:|---:|---:|---:|---|---:|
| failure | tied | existing | 5 | 5 | 1280 | 41 | 0.0320 | [0.0237, 0.0432] | 5 |
| failure | tied | new_train | 4 | 4 | 1024 | 46 | 0.0449 | [0.0338, 0.0594] | 4 |
| failure | untied | existing | 6 | 6 | 1536 | 98 | 0.0638 | [0.0526, 0.0771] | 6 |
| failure | untied | new_train | 6 | 6 | 1536 | 110 | 0.0716 | [0.0598, 0.0856] | 6 |
| proxy | tied | existing | 7 | 7 | 1792 | 48 | 0.0268 | [0.0203, 0.0353] | 3 |
| proxy | tied | new_train | 10 | 10 | 2560 | 0 | 0.0000 | [0.0000, 0.0015] | 1 |
| proxy | untied | existing | 7 | 7 | 1792 | 98 | 0.0547 | [0.0451, 0.0662] | 4 |
...
Each image summary gives one image identity one unit; image identities are split-aware and never keyed only by numeric COCO ID.
...
- Wilson intervals are per-state draw intervals; image summaries are descriptive image-level aggregates. No causal pooling across tied/untied or failure/proxy strata is performed.
