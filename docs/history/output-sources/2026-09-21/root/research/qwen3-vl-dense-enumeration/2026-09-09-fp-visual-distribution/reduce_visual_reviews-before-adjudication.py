...
def main():
    ...
    publish_json_exclusive(ROOT/'reviewed-cases.json',reviews)
    summary['reviewed_cases_sha256']=sha(ROOT/'reviewed-cases.json')
    publish_json_exclusive(ROOT/'review-summary.json',summary)
