...
def _items(
    ...
    if qualification:
        require(split is None and shard is None, "qualification omits split/shard")
...
def _gates(
    *, p: Mapping[str, Any], r: Mapping[str, Any], source: Mapping[str, Any], a64: Mapping[str, Any],
    ...
    repair = {
        ...
        "R_original_gain_count_gte_91": r_source["train"]["primary_class_agnostic_iou50"]["gained_count"] >= 91,
    }
    promotion = {}
    ...
    return {"repair_R_over_P": {"checks": repair, "passed": all(repair.values()), "debt": r_debt}, "promotion": promotion}, comparisons
