...
"""Durable one-shot launcher for the accepted content diagnostic."""
...
OUTPUT = CONTENT / "run-v1"
LOG = CONTENT / "run-v1.log"
LAUNCH_RECEIPT = CONTENT / "run-v1-launch-receipt.json"
TERMINAL_RECEIPT = CONTENT / "run-v1-terminal-receipt.json"
TIMEOUT_SECONDS = 13_500.0
PHYSICAL_GPU = "7"
EXPECTED = {
    ...
    WORKTREE / "probes/row_feedback/content_run.py": "c3b06ffe7465f1da86b38a32ea1713c84dd5a0be643836d9274d3437e449c423",
