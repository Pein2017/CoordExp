...
packet=/data/CoordExp/outputs/infra_base/untie-axis-20260918
...
packet=Path('/data/CoordExp/outputs/infra_base/untie-axis-20260918')
...
python -m src.prepare_train_cache --config "$config" --receipt "$packet/cache-preparation.json" > "$packet/cache-preparation.log" 2>&1
