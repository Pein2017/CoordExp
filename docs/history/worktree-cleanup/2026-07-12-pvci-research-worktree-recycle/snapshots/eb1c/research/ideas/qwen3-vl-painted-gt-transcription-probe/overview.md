...
This branch is a diagnostic research branch, not a final detector architecture.
The active branch is `codex/qwen3-vl-painted-gt-transcription-probe`, rooted
from the coordexp-infras backbone.
