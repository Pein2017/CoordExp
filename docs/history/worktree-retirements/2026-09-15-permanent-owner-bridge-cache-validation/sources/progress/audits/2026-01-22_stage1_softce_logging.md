---
doc_id: progress.audits.stage1-softce-logging-2026-01-22
layer: progress
doc_type: audit
status: historical-audit
domain: research-history
summary: Historical audit of Stage-1 SoftCE loss and logging behavior.
updated: 2026-03-09
---
...
Status note:
- this is a historical Stage-1 audit note,
- config paths under `configs/dlora/` are historical lineage rather than the current Stage-1 entrypoint,
- for current Stage-1 work, prefer `configs/stage1/` and `docs/training/README.md`.
...
- Metrics doc: `docs/training/METRICS.md`
- Stage-1 idea doc: `progress/pretrain/stage1_foundation.md`
