---
doc_id: progress.pretrain.stage1-ablation-2026-01-26
layer: progress
doc_type: benchmark
status: historical-reference
domain: research-history
summary: Historical Stage-1 ablation note for early pretraining choices.
updated: 2026-03-09
---
...
Context / intended Stage-1 goal (see `progress/pretrain/stage1_foundation.md` and `progress/directions/stage2_emish_set_supervision_v1.md`):
...
Stage-2 (per `progress/directions/stage2_emish_set_supervision_v1.md`) depends on rollout + parsing + matching, which often benefits from
