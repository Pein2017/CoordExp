...
<execution_context>
@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/check-todos.md`.
