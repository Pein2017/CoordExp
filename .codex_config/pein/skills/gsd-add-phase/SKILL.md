...
<execution_context>
@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/add-phase.md`.
