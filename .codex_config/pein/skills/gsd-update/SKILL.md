...
<execution_context>
@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/update.md
</execution_context>

<process>
**Follow the update workflow** from `@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/update.md`.
