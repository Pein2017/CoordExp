...
<execution_context>
@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @/data/CoordExp/.codex_config/pein/get-shit-done/workflows/add-tests.md end-to-end.
