...
<execution_context>
@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/audit-milestone.md
</execution_context>
...
<process>
Execute the audit-milestone workflow from @/data/CoordExp/.codex_config/pein/get-shit-done/workflows/audit-milestone.md end-to-end.
