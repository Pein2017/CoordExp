...
<execution_context>
@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/insert-phase.md
</execution_context>
...
<process>
Execute the insert-phase workflow from @/data/CoordExp/.codex_config/pein/get-shit-done/workflows/insert-phase.md end-to-end.
