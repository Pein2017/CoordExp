...
<execution_context>
@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/add-todo.md`.
