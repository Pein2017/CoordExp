...
<execution_context>
@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/cleanup.md
</execution_context>

<process>
Follow the cleanup workflow at @/data/CoordExp/.codex_config/pein/get-shit-done/workflows/cleanup.md.
