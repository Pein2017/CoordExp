...
<execution_context>
@/data/CoordExp/.codex_config/pein/get-shit-done/workflows/validate-phase.md
</execution_context>
...
<process>
Execute @/data/CoordExp/.codex_config/pein/get-shit-done/workflows/validate-phase.md.
