#!/usr/bin/env python3
"""Probe FA2 packed-row length numerical invariance for coordexp-infras."""
...
DEFAULT_CONFIG = (
    "configs/coordexp_infras/smoke/length_isolation/"
...
def main() -> int:
    ...
    payload = {
        "probe": "coordexp_infras_fa2_length_precision",
...
def _render_markdown(payload: dict[str, Any]) -> str:
    lines = [
        "# coordexp-infras FA2 Length Precision Probe",
        "",
