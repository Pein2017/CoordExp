    ...
    *,
    ...
    if bool(parsed.parse_failed) or parsed.objects_array_open_cut is None:
        ...
        return RolloutParseResult(
            ...
            invalid_rollout_reason="parse_failed_or_missing_objects_array",
            valid_objects=[],
            dropped_invalid=0,
    ...
    if not _is_append_ready_prefix(prefix_text):
        ...
        return RolloutParseResult(
            ...
            prefix_text=_EMPTY_PREFIX_TEXT,
            invalid_rollout=True,
            invalid_rollout_reason="prefix_not_append_ready",
            valid_objects=[],
            dropped_invalid=0,
            dropped_invalid_by_reason={},
            dropped_ambiguous=0,
    ...
    if invalid_rollout:
        ...
        return RolloutParseResult(
            ...
            prefix_text=_EMPTY_PREFIX_TEXT,
            invalid_rollout=True,
            invalid_rollout_reason="prefix_tail_not_append_ready",
            valid_objects=[],
            dropped_invalid=0,
            dropped_invalid_by_reason={},
            dropped_ambiguous=0,
...
def serialize_append_fragment(
    *,
    ...
    try:
        ...
        # Expected for append-ready partial prefixes; keep fail-fast for unexpected errors.
        pass
    else:
