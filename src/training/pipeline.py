...
def _resolve_shared_pinned_runtime_baseline(
    ...
    *,
    ...
    observed = _run_rank_converged_phase(
            ...
            try:
                writer.finalize(
                    ...
                    terminal_error=(
                        ...
                        f"{type(exc).__name__[:_CACHE_PREFLIGHT_IDENTITY_LIMIT]}"
                    ),
                )
            except BaseException:
                pass
...
def _cache_preparation_environment() -> dict[str, str]:
    return dict(_STRICT_CACHE_PREPARATION_ENVIRONMENT)
...
def _initialize_model_free_run_owner(
    *,
    ...
    control_plane = _build_model_free_control_plane(
        rank=launch_rank,
    ...
    *,
    ...
    try:
        ...
        (
            ...
            preflight_gatherer=preflight_gatherer,
            measurement_context=measurement_context,
            entry_started_at=entry_started_at,
        )
    except BaseException:
        close_preflight_gatherer = getattr(preflight_gatherer, "close", None)
        if callable(close_preflight_gatherer):
            close_preflight_gatherer()
        raise
    lifecycle: dict[str, Any] = {
        "completed_steps": 0,
        "consumed_packs": 0,
    ...
    rank_report_gatherer: Any | None = None
    ...
    try:
        ...
        preflight = _run_rank_converged_phase(
            "cache_preflight",
            rank=launch_rank,
            world_size=launch_world_size,
            rank_report_gatherer=preflight_gatherer,
            body=lambda: _resolve_model_free_training_preflight(
                config=config,
        ...
        rank_report_gatherer = _build_rank_report_gatherer(launch_world_size)
        ...
        _run_rank_converged_phase(
            ...
            world_size=launch_world_size,
            rank_report_gatherer=rank_report_gatherer,
            body=validate_post_accelerator_runtime,
        ...
        close_rank_report_gatherer = getattr(rank_report_gatherer, "close", None)
...
def _run_initialized_training(
    *,
    ...
    assembled = _run_rank_converged_phase(
        "model_loading",
    ...
    loss_runner, runtime, trainable_surface_receipt = _run_rank_converged_phase(
    ...
    if str(getattr(resume_config, "mode", "disabled")) == "exact_same_world_size":
        ...
        exact_identities = _run_rank_converged_phase(
        ...
        if resume_checkpoint_dir is not None:
            ...
            checkpoint_manifest = _run_rank_converged_phase(
            ...
            read_only_admission = _run_rank_converged_phase(
        ...
        def publish_exact_training_state(
            ...
            plan, cursor, next_micro_step = _run_rank_converged_phase(
...
def _gather_exact_resume_topology_bindings(
    *,
    ...
    local_snapshot = _run_rank_converged_phase(
