...
class RecursiveDetectionTargetsEnricher:
    """Attach recursive detection target sidecars for objective-owned trainer loss."""

    out_field = RECURSIVE_DETECTION_TARGETS_KEY
        ...
        *,
        ...
        if packed:
            ...
            if has_packed_sidecar:
                raise ValueError(
                    "recursive_detection_targets sidecars are incompatible with "
