...
# Design decision 7: the generic identity machinery now lives in the
# domain-neutral owner ``src.artifacts.identity``.  These are import-only
# compatibility re-exports under their existing parity names; a wrapper or a
# second body here would create two content-identity implementations.
from src.artifacts.identity import (
    MAX_WEIGHT_DECLARATIONS,  # noqa: F401 - historical import path
    MAX_WEIGHT_INDEX_BYTES,  # noqa: F401 - historical import path
    MAX_WEIGHT_SHARD_BYTES,  # noqa: F401 - historical import path
    MAX_WEIGHT_SHARDS,  # noqa: F401 - historical import path
    MAX_WEIGHT_TOTAL_BYTES,  # noqa: F401 - historical import path
    MODEL_WEIGHT_HASH_EXECUTION_POLICY_SCHEMA,  # noqa: F401 - historical path
    MODEL_WEIGHT_IDENTITY_SCHEMA,  # noqa: F401 - historical import path
    ParityContractError,
    _expect_exact_keys,
    _list_of_mappings,
    _mapping,
    ...
    _sha256_text,
    assert_absent_artifact_target,  # noqa: F401 - historical import path
    assert_model_weight_identity_equal,
    base_model_weight_identity,
    base_model_weight_identity_with_execution_policy,  # noqa: F401 - historical
