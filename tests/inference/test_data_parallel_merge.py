...
def test_strict_merge_restores_original_order_and_regenerates_bound_provenance(tmp_path: Path) -> None:
    ...
    assert "composition_mode" not in provenance
    assert "handoff_readiness" not in provenance
    assert "checkpoint_handoff" not in provenance
    assert "composition_mode" not in manifest
    assert "handoff_readiness" not in manifest
    assert "checkpoint_handoff" not in manifest
