...
4. If the user names `grill-me-with-docs`, use it before implementation. Batch obvious decisions with recommendations; reserve one-at-a-time questions for forks that change research meaning.
