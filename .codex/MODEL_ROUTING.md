...
> Current empirical state for Codex and Claude Code team selection. The
> experimental `agent-routing` skill owns the orchestration method where that
> skill is available; this file owns only availability, priors, and observations.
> Workers do not read this file.
