...
- For overlapping active deltas, this change is the authoritative helper-contract source; other deltas (for example `2026-02-11-refactor-src-modernization`) reference these helper contracts for integration/migration only.
