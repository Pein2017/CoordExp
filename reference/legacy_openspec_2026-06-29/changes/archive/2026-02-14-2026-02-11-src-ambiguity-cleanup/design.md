...
Other active deltas (for example `2026-02-11-refactor-src-modernization`) MAY reference these contracts for integration requirements but MUST NOT introduce conflicting helper-contract definitions.
