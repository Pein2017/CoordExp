...
This is a delta spec for change `2026-02-11-refactor-src-modernization`.

## ADDED Requirements

For overlapping active deltas, helper-consolidation normative details are delegated to `2026-02-11-src-ambiguity-cleanup`.
