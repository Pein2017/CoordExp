...
- Delegate helper-consolidation normative details (shared helper ownership, strict-parse defaults, root-image precedence/provenance) to `2026-02-11-src-ambiguity-cleanup`; this change keeps integration/migration requirements aligned to that authoritative helper contract.
