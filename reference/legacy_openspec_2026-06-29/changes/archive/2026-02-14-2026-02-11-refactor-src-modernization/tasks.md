...
- [x] 10.1 Align authority across active deltas: this change SHALL delegate helper-consolidation normative details to `2026-02-11-src-ambiguity-cleanup` and keep only integration/migration requirements here.
...
- [x] 10.7 Re-run strict validation for both active deltas after reconciliation: `openspec validate 2026-02-11-refactor-src-modernization --strict` and `openspec validate 2026-02-11-src-ambiguity-cleanup --strict`.
