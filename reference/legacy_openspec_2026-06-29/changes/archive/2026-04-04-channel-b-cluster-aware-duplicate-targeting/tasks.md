...
- [x] 1.1 Update the existing change-local delta specs for
      [stage2-ab-training/spec.md](/data/CoordExp/openspec/changes/channel-b-cluster-aware-duplicate-targeting/specs/stage2-ab-training/spec.md),
      [teacher-forcing-objective-pipeline/spec.md](/data/CoordExp/openspec/changes/channel-b-cluster-aware-duplicate-targeting/specs/teacher-forcing-objective-pipeline/spec.md),
      and
      [trainer-metrics-components/spec.md](/data/CoordExp/openspec/changes/channel-b-cluster-aware-duplicate-targeting/specs/trainer-metrics-components/spec.md)
...
- [x] 1.2 Add change-local delta specs for
      [inference-pipeline/spec.md](/data/CoordExp/openspec/specs/inference-pipeline/spec.md)
      and
      [detection-evaluator/spec.md](/data/CoordExp/openspec/specs/detection-evaluator/spec.md)
...
- [x] 2.1 Add a repo-owned shared duplicate-control runtime helper under
      ...
      expected as
      [duplicate_control.py](/data/CoordExp/src/common/duplicate_control.py),
      that owns:
...
- [x] 2.2 Reuse or extend
      ...
      and
      [prediction_parsing.py](/data/CoordExp/src/common/prediction_parsing.py)
      only as needed so infer/eval/train consume one normalized object contract.

## 3. Stage-2 Training Refactor

- [x] 3.1 Rewrite
      [build_channel_b_rollout_view()](/data/CoordExp/src/trainers/stage2_two_channel/rollout_views.py)
      ...
      duplicate metrics.
- [x] 3.2 Replace
      [_compute_duplicate_diagnostics()](/data/CoordExp/src/trainers/stage2_two_channel/target_builder.py)
      and
      [_sequential_dedup_bbox_objects()](/data/CoordExp/src/trainers/stage2_two_channel/target_builder.py)
      with shared duplicate-control consumption; update
      [_build_channel_b_triage()](/data/CoordExp/src/trainers/stage2_two_channel/target_builder.py),
      [_build_channel_b_supervision_targets()](/data/CoordExp/src/trainers/stage2_two_channel/target_builder.py),
      and
      [_build_duplicate_burst_unlikelihood_targets()](/data/CoordExp/src/trainers/stage2_two_channel/target_builder.py)
...
- [x] 3.3 Update
      ...
      [loss_duplicate_burst_unlikelihood.py](/data/CoordExp/src/trainers/teacher_forcing/modules/loss_duplicate_burst_unlikelihood.py).
- [x] 3.4 Update
      [resolve_stage2_ab_metric_spec()](/data/CoordExp/src/trainers/stage2_coordination.py)
...
- [x] 4.2 Update
      ...
      and
      [scripts/evaluate_detection.py](/data/CoordExp/scripts/evaluate_detection.py)
...
- [x] 5.1 Update
      ...
      and
      [ARTIFACTS.md](/data/CoordExp/docs/ARTIFACTS.md)
...
- [x] 6.1 Extend
      [tests/test_stage2_ab_training.py](/data/CoordExp/tests/test_stage2_ab_training.py)
...
- [x] 6.2 Extend
      [tests/test_stage2_pending_metrics_aggregation.py](/data/CoordExp/tests/test_stage2_pending_metrics_aggregation.py)
...
- [x] 6.3 Add or extend offline-eval coverage in
      [tests/test_detection_eval_output_parity.py](/data/CoordExp/tests/test_detection_eval_output_parity.py),
      [tests/test_detection_eval_ingestion_diagnostics.py](/data/CoordExp/tests/test_detection_eval_ingestion_diagnostics.py),
