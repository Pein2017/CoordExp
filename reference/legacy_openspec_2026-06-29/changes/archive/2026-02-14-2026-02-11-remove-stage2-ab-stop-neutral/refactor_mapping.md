...
This change set is intended to preserve **public behavior intent** while aligning spec language and references to the post-refactor codebase as defined by `openspec/changes/archive/2026-02-14-2026-02-11-src-ambiguity-cleanup`.
