...
Sequencing note:
- If also planning to land `2026-02-11-remove-stage2-ab-stop-neutral`, land this repeat-aware vLLM change first to isolate decode-time tail-control effects from training-objective changes.
