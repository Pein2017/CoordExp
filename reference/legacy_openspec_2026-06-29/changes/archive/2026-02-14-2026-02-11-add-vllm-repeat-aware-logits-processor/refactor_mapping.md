...
This change set is intended to preserve **public behavior** while aligning spec language and references to the post-refactor codebase as defined by `openspec/changes/archive/2026-02-14-2026-02-11-src-ambiguity-cleanup`.
...
- Change id + directory name:
  ...
  - New: `2026-02-11-add-vllm-repeat-aware-logits-processor`
