...
class Stage2RolloutMetaBase(TypedDict):
    stage2_surface: Literal["rollout_correction"]
    prompt_len: int
    prompt_ids: List[int]
    rollout_len: int
    prefix_len: int
...
class Stage2RolloutCorrectionMeta(Stage2RolloutMetaBase):
    stage2_surface: Literal["rollout_correction"]
...
Stage2RolloutMeta: TypeAlias = Stage2RolloutCorrectionMeta
Stage2ChannelBMeta: TypeAlias = Stage2RolloutCorrectionMeta
Stage2ChannelAMeta: TypeAlias = Stage2RolloutMetaBase
