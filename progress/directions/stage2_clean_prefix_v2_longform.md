---
title: Full Idea v2 Draft
status: active-reference
scope: stage2-channel-b
topics: [stage2, channel-b, clean-prefix, duplicate-ul]
entrypoint: progress/directions/stage2_clean_prefix_v2.md
references:
...
> Entry note: this is the detailed long-form v2 background writeup.
> For the stable entrypoint and precedence guidance, start with:
> - `docs/PROJECT_CONTEXT.md`
...
> This document is the detailed long-form research reference for the current v2 direction.
