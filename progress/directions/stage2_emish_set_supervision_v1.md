...
title: Full Idea
status: historical
scope: repo-direction
topics: [stage1, stage2, channel-a, historical-channel-b]
superseded_by: progress/directions/stage2_clean_prefix_v2.md
references:
...
> - `progress/directions/stage2_clean_prefix_v2.md`
> - `progress/directions/stage2_clean_prefix_v2_longform.md`
...
All sources are converted into a **shared JSONL contract** defined in `docs/data/CONTRACT.md`. Conceptually, each record corresponds to one or more images plus a set of annotated objects.
