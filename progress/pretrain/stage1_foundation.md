---
title: Phase 1 / Stage-1 Training
status: historical-reference
scope: stage1
topics: [stage1, coord-tokens, pretrain]
references:
...
> Status note: this file is useful historical background for Stage-1, but it is not the canonical current training entrypoint.
> For current read order and stable docs, start with:
> - `docs/PROJECT_CONTEXT.md`
> - `docs/training/README.md`
> - `docs/training/STAGE1_OBJECTIVE.md`
> - `docs/data/README.md`

This note describes the historical Stage-1 baseline SFT recipe that was current at the time it was written and used in CoordExp to teach the model to:
...
- **Historical Stage-1 source-of-truth strategy**: `configs/dlora/sft_stage1_softce_w1.yaml`
...
- Data schema (authoritative): `docs/data/CONTRACT.md`
- Preprocessing pipeline (authoritative): `docs/data/PREPARATION.md`
...
## 4) Stage-1 Config Surface (historical snapshot)

Stage-1 runs are configured via YAML (avoid ad-hoc CLI flags).

The historical reference config captured here is: `configs/dlora/sft_stage1_softce_w1.yaml`.
...
- Preprocessing pipeline: `docs/data/PREPARATION.md`
