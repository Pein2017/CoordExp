# coordexp-infras-research-probe-admission Specification
...
digest-bind that worktree but MUST NOT edit, stage, commit, merge,
cherry-pick, push, or rewrite it. This does not forbid a separately
user-authorized, reviewed integration of an accepted branch developed in the
fixed `/data/CoordExp/.worktrees/research-probe-infras` worktree into
