# coordexp-swift-detection-evaluator Specification

## Purpose
TBD - created by archiving change standardize-coordexp-swift-detection-evaluator. Update Purpose after archive.
## Requirements
