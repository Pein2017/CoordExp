...
The shared module SHALL include helpers to:
- convert a polygon to a tight bbox, and
- convert a bbox to a minimal quadrilateral segmentation

so that bbox GT can be matched against polygon predictions (and vice versa) via IoU.
