# public-data-adapter-factory Specification

## Purpose
Define the dataset adapter registry/factory and adapter-to-pipeline boundary contract for the unified public-data pipeline.
