...
coordexp-infras SHALL call the Qwen3-VL model for logits and declared model
...
coordexp-infras SHALL leave Qwen visual tower execution and replacement of
image placeholders with visual features inside the Transformers Qwen3-VL
forward path or an explicitly approved Qwen wrapper. coordexp-infras MUST
