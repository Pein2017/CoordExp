...
Sequencing note:
- If also planning to land `add-vllm-repeat-aware-logits-processor`, prefer landing that change first to reduce attribution ambiguity (decode-time tail guardrail vs. training-time stop calibration).
