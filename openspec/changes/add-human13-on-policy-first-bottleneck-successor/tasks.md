...
- [x] 4.2 Execute one real vertical proposal through HF scoring, two forced continuations, packed forward/backward, AdamW, post-update clean greedy, checkpoint/analyzer handling, and a deliberate reject/rollback drill.
- [x] 4.3 Verify restored model and optimizer state hashes plus clean-greedy owner-set reproduction; publish a mechanics-only vertical receipt or stop without launching the pilot.
