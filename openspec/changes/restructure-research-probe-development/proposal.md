...
- `coordexp-swift-research-probe-infra-base`: native research execution independent of packed/session machinery; exact replay and budgeted continuation; aligned scoring and assignment with explicit semantics; lightweight default usage with optional strict capabilities.
...
- Initial edits affect selected Qwen/HF mechanics, losses, adapter/optimizer inputs, evaluation geometry/assignment, direction packages, their callers/tests/configs, local documentation and this change. Production main and CoordExp-Swift are unaffected.
