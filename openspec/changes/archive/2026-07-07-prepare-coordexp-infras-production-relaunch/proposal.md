# Prepare coordexp-infras Production Relaunch

## Why

The rebuilt coordexp-infras training stack has passed its V1 rebuild gates, but
...
- The completed `rebuild-coordexp-infras-training-infra` OpenSpec remains
