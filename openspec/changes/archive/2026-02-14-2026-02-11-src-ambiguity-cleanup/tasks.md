...
- [x] 7.2 Run focused validation: `PYTHONPATH=. conda run -n ms python -m py_compile <touched files>`, `PYTHONPATH=. conda run -n ms python -m pytest -q <target tests>`, and `openspec validate 2026-02-11-src-ambiguity-cleanup --strict`.
