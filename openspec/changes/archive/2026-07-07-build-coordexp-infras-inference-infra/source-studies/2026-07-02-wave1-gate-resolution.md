...
`build-coordexp-infras-inference-infra`. It records evidence for the first
...
- Docs contradiction carried as implementation risk: at source-study time,
  ...
  to route through coordexp-infras first.
...
- V1 inference config under `configs/coordexp_infras/infer/`, not
  `configs/infer/*`.
