...
- Base single-row smoke config: `configs/coordexp_infras/infer/wave7_real_base_single_smoke.yaml`
- Base two-row smoke config: `configs/coordexp_infras/infer/wave7_real_base_batched_smoke.yaml`
- Adapter smoke config: `configs/coordexp_infras/infer/wave7_real_adapter_smoke.yaml`
- Benchmark packet: `docs/superpowers/plans/2026-07-02-coordexp-infras-wave7-benchmark-readiness.md`

## Commands Run

```bash
CUDA_VISIBLE_DEVICES=4 python -m src.infer --config configs/coordexp_infras/infer/wave7_real_base_single_smoke.yaml
CUDA_VISIBLE_DEVICES=4 python -m src.infer --config configs/coordexp_infras/infer/wave7_real_base_batched_smoke.yaml
CUDA_VISIBLE_DEVICES=4 python -m src.infer --config configs/coordexp_infras/infer/wave7_real_adapter_smoke.yaml
CUDA_VISIBLE_DEVICES=4 python -m src.infer --config configs/coordexp_infras/infer/wave7_real_adapter_smoke.yaml
...
- PASS, production-adapter two-row smoke with corrected COCO prompt: `outputs/coordexp_swift/infer/wave7_real_smokes/wave7-real-production-adapter-smoke`
  - Config: `configs/coordexp_infras/infer/wave7_real_production_adapter_smoke.yaml`
