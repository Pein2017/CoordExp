...
`add-coordexp-infras-infer-data-parallelism` change. It is a tiny two-row,
...
```bash
CUDA_VISIBLE_DEVICES=0,2 python -m src.infer --config configs/coordexp_infras/infer/dp-smoke-reviewfix-GAOS.yaml
```
...
- Artifact root:
  `/data/CoordExp/.worktrees/coordexp-infras/outputs/coordexp_swift/infer/data_parallel_smokes/coordexp-swift-infer-dp-2gpu-smoke-reviewfix`
- Stable resolved config evidence:
  `/data/CoordExp/.worktrees/coordexp-infras/outputs/coordexp_swift/infer/data_parallel_smokes/coordexp-swift-infer-dp-2gpu-smoke-reviewfix/configs/resolved.yaml`
  and
  `/data/CoordExp/.worktrees/coordexp-infras/outputs/coordexp_swift/infer/data_parallel_smokes/coordexp-swift-infer-dp-2gpu-smoke-reviewfix/configs/resolved.json`
- Backend: `hf`
- Model:
  `/data/CoordExp/model_cache/models/Qwen/Qwen3-VL-2B-Instruct-coordexp-natural-adjacent`
- Input JSONL:
  `/data/CoordExp/.worktrees/coordexp-infras/tests/fixtures/smoke/qwen3_vl_single_image_pack/examples.jsonl`
- Rows: 2
...
- `src.eval.detection_consumer.evaluate_scored_detection_artifacts` consumed
  ...
  `/data/CoordExp/.worktrees/coordexp-infras/outputs/coordexp_swift/infer/data_parallel_smokes/coordexp-swift-infer-dp-2gpu-smoke-reviewfix/eval_detection/metrics.json`.
- The evaluator also wrote:
  `/data/CoordExp/.worktrees/coordexp-infras/outputs/coordexp_swift/infer/data_parallel_smokes/coordexp-swift-infer-dp-2gpu-smoke-reviewfix/eval_detection/evaluation_receipt.json`.
...
coordexp_infras_detection_coco_bbox_v1`, `row_count: 2`, `mAP: 0.0`, and
...
openspec validate add-coordexp-infras-infer-data-parallelism --strict
git diff --check
```
...
- `Pytest: 154 passed`
- `Change 'add-coordexp-infras-infer-data-parallelism' is valid`
...
run = Path("/data/CoordExp/.worktrees/coordexp-infras/outputs/coordexp_swift/infer/data_parallel_smokes/coordexp-swift-infer-dp-2gpu-smoke-reviewfix")
required = [
    "gt_vs_pred.jsonl",
