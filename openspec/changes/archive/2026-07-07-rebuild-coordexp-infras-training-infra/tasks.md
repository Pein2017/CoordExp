...
- [x] 1.1 Draft `design.md` from `DECISIONS.md`, `BLUEPRINT.md`, and accepted
  review verdicts.
- [x] 1.2 Draft `coordexp-infras-config-runtime` delta spec.
- [x] 1.3 Draft `coordexp-infras-data-template-encoding` delta spec.
- [x] 1.4 Draft `coordexp-infras-packing-forward` delta spec.
- [x] 1.5 Draft `coordexp-infras-supervision-losses` delta spec.
- [x] 1.6 Draft `coordexp-infras-adapters-embeddings-optim` delta spec.
- [x] 1.7 Draft `coordexp-infras-training-artifacts` delta spec.
- [x] 1.8 Draft `coordexp-infras-vertical-smoke` delta spec.
