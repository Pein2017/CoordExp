...
- **P1 accepted and patched:** `docs/ARTIFACTS.md` described legacy
  ...
  compact-detection artifacts from the coordexp-infras fail-fast
...
- `openspec validate rebuild-coordexp-infras-training-infra --strict` passed;
...
`agent_verdict/coordexp-infras-claude.md` and
`agent_verdict/coordexp-infras-codex.md` were reviewed against the live rebuilt
