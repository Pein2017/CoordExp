...
- [x] 1.3 Verify current coordexp-infras inference artifact fields in `gt_vs_pred.jsonl`, `gt_vs_pred_scored.jsonl`, `parse_diagnostics.jsonl`, and provenance sidecar before coding.
...
- [x] 5.3 Run `openspec validate standardize-coordexp-infras-detection-evaluator --strict`.
