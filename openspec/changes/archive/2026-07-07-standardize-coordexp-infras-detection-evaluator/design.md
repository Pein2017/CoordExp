# coordexp-infras Detection Evaluator Design

## Context

coordexp-infras inference owns a rebuilt output stack:
...
- define a standard coordexp-infras evaluator for `gt_vs_pred_scored.jsonl`;
