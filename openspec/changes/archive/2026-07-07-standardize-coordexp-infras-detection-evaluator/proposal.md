...
coordexp-infras inference now writes scored detection artifacts, but the current
...
- Add a standardized coordexp-infras detection evaluator contract for
...
- `coordexp-infras-detection-evaluator`: Defines the standardized offline
  detection evaluator for coordexp-infras scored inference artifacts, including
