...
- **Cross-change authority split:** for overlapping helper-consolidation requirements (`coord-utils`, evaluator ingestion strictness, root-image resolution contract), `2026-02-11-src-ambiguity-cleanup` is authoritative. This change carries integration/migration constraints and MUST reference the authoritative helper contracts instead of re-defining conflicting variants.
