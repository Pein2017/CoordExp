...
When geometry flips are enabled for training, coordexp-infras SHALL materialize
...
coordexp-infras SHALL define geometry flips as affine transforms over the
...
coordexp-infras SHALL apply the realized geometry transform to image pixels in
...
coordexp-infras SHALL preserve the existing object-ordering contract while
...
coordexp-infras SHALL include augmentation semantics in the packing-cache
...
coordexp-infras SHALL record compact augmentation provenance for cache misses and
