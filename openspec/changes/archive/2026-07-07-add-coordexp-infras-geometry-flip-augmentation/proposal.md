...
coordexp-infras needs a small geometry augmentation path that can improve
...
- Add train-only static stochastic geometry flip augmentation for
  coordexp-infras supervised training.
...
- `coordexp-infras-geometry-augmentation`: train-only static stochastic
...
- `docs/superpowers/specs/2026-07-07-coordexp-infras-geometry-flip-augmentation-design.md`
