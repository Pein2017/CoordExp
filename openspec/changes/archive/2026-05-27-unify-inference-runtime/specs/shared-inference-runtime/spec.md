...
Define the shared detection inference/decode/preprocessing runtime used by
offline inference/evaluation, online Stage-2 rollout generation, rollout
diagnostics, and score-aware metric workflows.
