# Active readout geometry — lead-accepted descriptive evidence

Root accepted this bounded record on2026-09-18. The [lead receipt](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-highconfidence18-natural/lead-acceptance.json) owns acceptance and preserved candidate bindings. Gradient scientific evidence remains invalid; feedback remains unexecuted. No successor is released.
...
|---|---:|---:|---:|---:|---:|
| tied | 152 | 44 | 31 | 13 | 48 |
| untied | 140 | 46 | 27 | 19 | 55 |
...
[Result](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-active-readout-geometry/result.json), [event selection](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-active-readout-geometry/events.json), [per-event summary](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-active-readout-geometry/summary.json), [artifact map](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-active-readout-geometry/ARTIFACTS.md), [terminal](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-active-readout-geometry/terminal.json). CPU reproduction: `PYTHONPATH=. python /data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-18-untied-active-readout-geometry/summarize.py`.
