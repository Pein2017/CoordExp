# Lane A results: recurrence distribution census

**Lead acceptance (2026-09-19):** Descriptive recurrence census accepted for separate mature145 and prospective seed19-128 strata; no physical duplicate census or untie-only causal claim. Original overwritten metadata bytes remain an archival gap. [Independent receipt](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-19-recurrence-distribution-census/integration/lead-acceptance.json). Candidate snapshots and raw evidence are preserved. No successor is released.
