...
**Lead acceptance (2026-09-19):** Actual structured initializer/input/readout geometry and 16-state fixed-suffix y2 continuity accepted; 1/32 immediate winner changes, 0 later. No x1-input or free-trajectory stability claim; one original shard receipt remains unavailable. [Independent receipt](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-19-recurrence-distribution-census/integration/lead-acceptance.json). Candidate snapshots and raw evidence are preserved. No successor is released.

**Status:** lead-accepted within stated evidence and archival limits.  
...
Values are medians within each group and site. The coord columns center only the 1,000 coordinate logits; the full-vocab columns center the complete vocabulary logits. Both margin ratios use the native full-vocabulary top-two margin. pair Delta is the change in the native-coordinate versus replacement-coordinate logit gap. coord-family L1 is the L1 change in the softmax distribution conditional on the 1,000-coordinate family, not a full-vocabulary probability. rank is the native winner's rank under the variant; replacement rank is the replaced coordinate's rank under the variant. Winner flips are full-vocabulary flips, with the coordinate-winner flip count equal in this cohort.

| stratum / model | site | n | input Delta-h L2 | coord centered Delta-infinity | coord Delta-infinity / margin | full-vocab centered Delta-infinity | full-vocab Delta-infinity / margin | coord pair Delta | coord-family L1 | native rank | replacement rank | winner flips |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| failure / tied | immediate | 8 | 0.2201 | 0.01937 | 0.8376 | 0.02917 | 1.171 | -0.000254 | 0.00565 | 1 | 395.5 | 0/8 |
| failure / tied | later | 8 | 0.2201 | 0.01251 | 0.3327 | 0.01894 | 0.4238 | -5.91e-05 | 0.00312 | 1 | 413 | 0/8 |
| failure / untied | immediate | 8 | 0.2405 | 0.04654 | 0.6676 | 0.0615 | 0.8732 | 6.58e-05 | 0.00882 | 1 | 624 | 1/8 |
| failure / untied | later | 8 | 0.2405 | 0.03195 | 0.825 | 0.04205 | 1.123 | -8.3e-05 | 0.0109 | 1 | 616.5 | 0/8 |
| proxy / tied | immediate | 8 | 0.2209 | 0.01246 | 0.1309 | 0.02042 | 0.1723 | -0.000259 | 0.00304 | 1 | 304.5 | 0/8 |
| proxy / tied | later | 8 | 0.2209 | 0.02244 | 0.4463 | 0.03309 | 0.6153 | 5.44e-05 | 0.00431 | 1 | 304.5 | 0/8 |
| proxy / untied | immediate | 8 | 0.2385 | 0.026 | 0.1206 | 0.04694 | 0.1628 | -0.00143 | 0.00609 | 1 | 272 | 0/8 |
| proxy / untied | later | 8 | 0.2385 | 0.01107 | 0.0292 | 0.02308 | 0.05485 | -8.11e-05 | 0.00207 | 1 | 273 | 0/8 |

The target embedding perturbation is substantial and model-dependent: median input Delta-h L2 is 0.220 for failure/tied, 0.240 for failure/untied, 0.221 for proxy/tied, and 0.238 for proxy/untied. The untied input rows therefore show a larger input perturbation than tied rows in these selected states. The readout response is not a simple monotone failure/proxy effect: failure rows are larger at both sites for untied, while proxy/tied has the larger later-site margin-normalized median (0.446 versus 0.333 for failure/tied). Full-vocabulary centering is larger than coordinate-only centering in every group/site: the full-vocabulary Delta-infinity / margin medians range from 0.055 to 1.17, while the coordinate-only medians range from 0.029 to 0.838. The pooled full-vocabulary Delta-infinity median is 0.0438 immediate and 0.0255 later; the corresponding pooled ratios are 0.251 and 0.476.
...
| source panel | site | n | input Delta-h L2 | coord Delta-infinity / margin | full-vocab Delta-infinity / margin | coord-family L1 | winner flips |
|---|---:|---:|---:|---:|---:|---:|---:|
| 2026-09-18-numerical-recurrence-feedback | immediate | 4 | 0.2385 | 0.1126 | 0.134 | 0.017 | 0/4 |
| 2026-09-18-numerical-recurrence-feedback | later | 4 | 0.2385 | 0.08171 | 0.1119 | 0.00712 | 0/4 |
| 2026-09-18-untied-highconfidence18-natural | immediate | 10 | 0.2353 | 0.1258 | 0.1983 | 0.00466 | 0/10 |
| 2026-09-18-untied-highconfidence18-natural | later | 10 | 0.2353 | 0.02315 | 0.04824 | 0.00151 | 0/10 |
| 2026-09-19-recurrence-distribution-census | immediate | 18 | 0.2249 | 0.6287 | 0.8968 | 0.00579 | 1/18 |
| 2026-09-19-recurrence-distribution-census | later | 18 | 0.2249 | 0.5047 | 0.6944 | 0.0088 | 0/18 |

The recurrence-distribution census supplies 18/32 contrasts and has coordinate-only margin-normalized medians 0.629 immediate and 0.505 later, versus full-vocabulary medians 0.731 and 0.614. The high-confidence natural panel supplies 10/32 with coordinate-only 0.126 and 0.023, versus full-vocabulary 0.178 and 0.044. The numerical-recurrence panel supplies 4/32 with coordinate-only 0.113 and 0.082, versus full-vocabulary 0.146 and 0.097. These are source-panel strata, not a claim that source provenance causes the response.
