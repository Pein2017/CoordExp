...
**Lead acceptance (2026-09-19):** 45-state supplied-description numerical-event probability accepted from 11520 draws; low event mass can coexist with greedy recurrence. Seven empty proxy unions remain structural zeros; 1-q is not new-owner probability. [Independent receipt](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-19-recurrence-distribution-census/integration/lead-acceptance.json). Candidate snapshots and raw evidence are preserved. No successor is released.

Status: **lead-accepted within stated evidence limits**.
