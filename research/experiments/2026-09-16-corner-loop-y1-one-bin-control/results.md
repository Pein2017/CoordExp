# Final paired coordinate-substitution result

**Lead-accepted; bounded negative result.** Independent CPU replay confirms the exact saved-token metrics, sole literal delta at1229, unchanged1851-token free suffix, three companion identities, native runtime identity and supplied-row credit-exclusion sensitivity. [Lead receipt](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/lead-acceptance.json) and [CPU verifier](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/lead_verify.py) retain the evidence; original candidate records and result/terminal bytes are preserved. The local coordinate-substitution series is closed. The subsequent user grant for overnight mechanism diagnosis requires a separate unit.
...
Cost: 3084 native bs4 forwards (12336 batch slots including finished-companion padding),1 vision invocation, 368.580727 allocated GPU-seconds (0.102384 GPU-hours), within5000 forwards and intended1800 seconds. One successful model attempt, exit0; no live owned jobs. Runtime wall time includes loading/checks, not kernel-only time. A host event-wait initially lacked os.pidfd_open and was replaced with the Linux pidfd syscall; no producer/model rerun or execution change resulted.

- [panel.json](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/panel.json)
- [producer.py](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/producer.py)
- [producer.diff](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/producer.diff)
- [reduce.py](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/reduce.py)
- [verify.py](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/verify.py)
- [result.json](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/result.json)
- [edit-receipt.json](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/edit-receipt.json)
- [runtime/Y1_998/raw.json](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/runtime/Y1_998/raw.json)
- [runtime/Y1_998/receipt.json](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/runtime/Y1_998/receipt.json)
- [run.sh](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/run.sh)
- [launch.json](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/launch.json)
- [terminal.json](/data/CoordExp/outputs/research/qwen3-vl-dense-enumeration/2026-09-16-corner-loop-y1-one-bin-control/terminal.json)
