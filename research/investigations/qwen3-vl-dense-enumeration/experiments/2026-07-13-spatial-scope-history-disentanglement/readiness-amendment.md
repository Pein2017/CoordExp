...
> **Post-execution provenance notice:** this file preserves the intended,
> frozen protocol. The executed provenance and current evidentiary status of
> Independent Reviewer One are corrected in
> [Annotation Review Provenance and Interpretation
> Correction](annotation-review-provenance-correction.md). In particular, its
> labels were generated by an image-viewing model and are not human-confirmed
> ground truth.
