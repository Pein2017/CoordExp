...
- Recorded input: `coco_val200_len12000.rebased_images.coord.jsonl` from the CoordExp-Swift worktree.
...
| Serialization | `/data/CoordExp/.worktrees/CoordExp-swift/research/decisions/prefer-x-then-y-object-ordering.md` | exists, clean | Current bounded decision; correctly records compound evidence |
