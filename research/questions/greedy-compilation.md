...
## Completed finite-task learning and later compilation tests

[The fourth-fit result](../experiments/2026-09-14-training-set-completion-curriculum/results.md) owns its intermediate fixed versus supplemental population, per-image changes, loss curve and review rules. Its [closed state](../experiments/2026-09-14-training-set-completion-curriculum/state.json) and [original protocol and phase history](../../docs/history/research-records/2026-09-15/investigations/qwen3-vl-dense-enumeration/experiments/2026-09-14-training-set-completion-curriculum/unit.md) are historical boundaries, not live launch documents.
...
That finite cumulative task permitted different legitimate output orders and representations, required per-image completion before growth, and deferred an early validation veto. Later [CE-normalization arms](../experiments/2026-09-15-coco227-ce-normalization/results.md) reached clean227/227 and [22-image expansion](../experiments/2026-09-15-coco22-cumulative-expansion/results.md) reached376/376. Finite fitting is established on these tasks; their historical acceptance rules do not override later train/dev preservation gates.

[Source256 fixed-history completion](../experiments/2026-09-16-source256-fixed-prefix-completion/results.md), its [CE-normalization successor](../experiments/2026-09-16-source256-completion-ce-normalization/results.md), and [P/R16 ranking repair](../experiments/2026-09-16-source256-output-ranking-repair/results.md) are closed without joint promotion. The ranking arm's local FN benefit coexisted with identity turnover and repetition. These tests neither isolate online refresh nor justify another finite-fit demonstration as the next research goal.

The [fresh128 norm-policy result](../experiments/2026-09-17-readout-norm-fresh128/results.md) shows that output-only inference changes can reduce structural failures without learning, while population physical benefit remains unresolved. The [human-review successor discussion](../experiments/2026-09-17-readout-norm-fresh128/human-review-duplication-discussion.md) proposes an inference-only complete-row contrast at confirmed recurrence. Supplied-row success is conditional evidence; recovery credit belongs only to later freely emitted owners, with incumbents and credible unlabeled owners tracked separately.
